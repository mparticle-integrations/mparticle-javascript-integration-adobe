...
describe('AdobeEventForwarder Forwarder', function () {
    ...
    function configureAdobeForwarderAndReInit(timestampOption) {
        mParticle.configureForwarder({
            name: 'Adobe',
            settings: {
                productIncrementor:'[   {&quot;maptype&quot;:&quot;ProductAttributeSelector.Name&quot;,&quot;value&quot;:&quot;event2&quot;,&quot;map&quot;:&quot;PI1&quot;,&quot;jsmap&quot;:&quot;110936&quot;},\
                                        {&quot;maptype&quot;:&quot;ProductAttributeSelector.Name&quot;,&quot;value&quot;:&quot;event6&quot;,&quot;map&quot;:&quot;PI2&quot;,&quot;jsmap&quot;:&quot;110937&quot;}]',
                productMerchandising:'[ {&quot;maptype&quot;:&quot;ProductAttributeSelector.Name&quot;,&quot;value&quot;:&quot;eVar2&quot;,&quot;map&quot;:&quot;PM1&quot;,&quot;jsmap&quot;:&quot;111060&quot;},\
                                        {&quot;maptype&quot;:&quot;ProductAttributeSelector.Name&quot;,&quot;value&quot;:&quot;eVar3&quot;,&quot;map&quot;:&quot;PM2&quot;,&quot;jsmap&quot;:&quot;111061&quot;}]',
                ...
                evars:'[{&quot;maptype&quot;:&quot;EventAttributeClass.Name&quot;,&quot;value&quot;:&quot;eVar1&quot;,&quot;map&quot;:&quot;color&quot;},\
                        {&quot;maptype&quot;:&quot;UserAttributeClass.Name&quot;,&quot;value&quot;:&quot;eVar10&quot;,&quot;map&quot;:&quot;color&quot;}]',
                props:'[{&quot;maptype&quot;:&quot;UserAttributeClass.Name&quot;,&quot;value&quot;:&quot;prop5&quot;,&quot;map&quot;:&quot;gender&quot;},\
                        {&quot;maptype&quot;:&quot;EventAttributeClass.Name&quot;,&quot;value&quot;:&quot;prop2&quot;,&quot;map&quot;:&quot;gender&quot;},\
                        {&quot;maptype&quot;:&quot;EventAttributeClass.Name&quot;,&quot;value&quot;:&quot;prop3&quot;,&quot;map&quot;:&quot;color&quot;}]',
                // "Find Ticket", "discount"
                events:'[{&quot;maptype&quot;:&quot;EventClassDetails.Id&quot;,&quot;value&quot;:&quot;event1&quot;,&quot;map&quot;:&quot;-1975600560116162357&quot;,&quot;jsmap&quot;:&quot;750057686&quot;},\
                        {&quot;maptype&quot;:&quot;EventClass.Id&quot;,&quot;value&quot;:&quot;event7&quot;,&quot;map&quot;:&quot;discount&quot;,&quot;jsmap&quot;:&quot;-100343221&quot;}]',
    ...
    it('should log page view', function(done) {
        mParticle.Identity.getCurrentUser().setUserAttribute('color', 'red');
        ...
        s.eVar10.should.equal('red');
        s.prop2.should.equal('female');
        s.prop5.should.equal('male');
    ...
    it('should log an event when trying to log a mapped page view value', function(done) {
        ...
        s.eVar1.should.equal('green');
        s.eVar10.should.equal('blue');
        s.prop2.should.equal('female');
        s.prop5.should.equal('female');
        s.hier1.should.equal('test');
        s.contextData.contextTestValue.should.equal('c1testValue');
        ...
        (s.linkTrackVars.indexOf('prop5') >= 0).should.equal(true);
    ...
    it('should not log event that is not mapped', function(done) {
        mParticle.logEvent('blah', EventType.Navigation, {color: 'green', gender: 'female', c1: 'c1testValue', linkName: 'test'});
    ...
    it('should log a product purchase with proper events, product merchandising events, and product incrementor events', function(done) {
        mParticle.Identity.getCurrentUser().setUserAttribute('color', 'red');
        mParticle.Identity.getCurrentUser().setUserAttribute('gender', 'male');
    ...
    it('should log a product view', function(done) {
        ...
        (s.linkTrackVars.indexOf('prop5') >= 0).should.equal(true);
        (s.linkTrackVars.indexOf('eVar1') >= 0).should.equal(true);
        (s.linkTrackVars.indexOf('eVar10') >= 0).should.equal(true);
